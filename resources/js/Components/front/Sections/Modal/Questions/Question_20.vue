<template>
    <h2 class="modal_title">Какого типа сайт у Вас?</h2>
    <div class="row">
        <div class="col-md-12 margin-answer">
            <div class="col-md-6">
                <label>
                    <input type="radio" name="q_20" value="1" @click="this.vizitkaPriceUpdate()"/>
    ...
    <div class="row">
        <div class="col-md-12 margin-answer">
            <div class="col-md-6">
                <label>
                    <input type="radio" name="q_20" value="2" @click="this.one_pagePriceUpdate()" />
                    <div class="btn btn-sık">
    ...
    <div class="row">
        <div class="col-md-12 margin-answer">
            <div class="col-md-6">
                <label>
                    <input type="radio" name="q_20" value="3" @click="this.many_pagePriceUpdate()"/>
                    <div class="btn btn-sık">
    ...
    <div class="row">
        <div class="col-md-12 margin-answer">
            <div class="col-md-6">
                <label>
                    <input type="radio" name="q_20" value="4" @click="this.corpPriceUpdate()"/>
                    <div class="btn btn-sık">
    ...
    <div class="row">
        <div class="col-md-12 margin-answer">
            <div class="col-md-6">
                <label>
                    <input type="radio" name="q_20" value="5" @click="this.shopPriceUpdate()"/>
                    <div class="btn btn-sık">
                        <span>Магазин</span>
                    </div>
                </label>
...
export default defineComponent({
    ...
    methods:{
        vizitkaPriceUpdate(){
            this.$parent.$parent.$parent.price = 20000
        },
        one_pagePriceUpdate(){
            this.$parent.$parent.$parent.price = 30000
        },
        many_pagePriceUpdate(){
            this.$parent.$parent.$parent.price = 50000
        },
        corpPriceUpdate(){
        ...
        nextPage(){
            let radios = document.querySelectorAll('input[name="q_20"]')
            let hasChecked = false;
            for (let radio of radios) {
                if (radio.checked) {
                    hasChecked = true
                    let q_20 = document.querySelector('input[name="q_20"]:checked').value
                    if(q_20 === '1'){
                    ...
                    this.$parent.$parent.modal_page = '2' + q_20
                }
            }
            if(!hasChecked){
            ...
            let q_20 = document.getElementById('q_20')
            q_20.style.position = 'absolute'
            setTimeout(() => {
                q_20.style.position = 'relative'
            },500)
        },
    }
})
