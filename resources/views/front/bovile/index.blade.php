                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <div class="slider-image">
                            <img src="{{ asset('front/bovile/images/slider/slider-1.jpg') }}" alt="slider-1"/>
                    ...
                    <div class="item">
                        <div class="slider-image">
                            <img src="{{ asset('front/bovile/images/slider/slider-2.jpg') }}" alt="slider-2"/>
                            <div class="carousel-caption">
                                <div class="container">
                                    <h5>Welcome to fishing</h5>
                    ...
                    <div class="item">
                        <div class="slider-image">
                            <img src="{{ asset('front/bovile/images/slider/slider-3.jpg') }}" alt="slider-3"/>
                            <div class="carousel-caption">
                                <div class="container">
                                    <h5>Welcome to fishing</h5>
        ...
        <div class="intro-section tr-border container-fluid no-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6">
                        <div class="intro-content">
                            <i><img src="{{ asset('front/bovile/images/intro/choose-2.jpg') }}" alt="choose-2"></i>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6">
                        <div class="intro-content">
                            <i><img src="{{ asset('front/bovile/images/intro/choose-3.jpg') }}" alt="choose-3"></i>
                            <h3>Fishing tools</h3>
                            <p>Straightnin' the curves. Flatnin' the hills Someday the mountain might get 'em but the law never Got kind of tired packin unpackin</p>
                            <a href="#">Read More</a>
                        </div>
                    ...
                    <div class="product-carousel">
                        <div class="col-md-12">
                            <div class="product-block">
                                ...
                                <div class="product-img-box"><img src="{{ asset('front/bovile/images/product/product1.png') }}" alt="product1"/></div>
                        ...
                        <div class="col-md-12">
                            <div class="product-block">
                                <span class="new" title="New">New</span>
                                <a href="#" class="product-wish pull-right" title="Add Wish"><i class="fa fa-heart-o"></i></a>
                                <div class="product-img-box"><img src="{{ asset('front/bovile/images/product/product2.png') }}" alt="product1"/></div>
                                <div class="product-info">
                                    <h4>Fishing line</h4>
                                    <span>
										<i class="fa fa-star"></i>
                        ...
                        <div class="col-md-12">
                            <div class="product-block">
                                ...
                                <a href="#" class="product-wish pull-right" title="Add Wish"><i class="fa fa-heart-o"></i></a>
                                <div class="product-img-box"><img src="{{ asset('front/bovile/images/product/product3.png') }}" alt="product1"/></div>
                                <div class="product-info">
                                    <h4>Fishing reel</h4>
                                    <span>
										<i class="fa fa-star"></i>
                        ...
                        <div class="col-md-12">
                            <div class="product-block">
                                <span class="new" title="New">New</span>
                                <a href="#" class="product-wish pull-right" title="Add Wish"><i class="fa fa-heart-o"></i></a>
                                <div class="product-img-box"><img src="{{ asset('front/bovile/images/product/product4.png') }}" alt="product1"/></div>
                                <div class="product-info">
                                    <h4>Fishing rod</h4>
                                    <span>
										<i class="fa fa-star"></i>
