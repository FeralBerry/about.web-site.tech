...
<header class="main-header">
    <div class="auto-container clearfix">
        ...
        <!-- Logo -->
        <div class="logo"><a href="#"><img src="{{ asset('front/stayfit/images/logo.png') }}" alt="Logo" title="StayFit"></a></div>
        ...
        <nav class="main-menu">
            ...
            <div class="navbar-collapse collapse clearfix">
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a href="{{ route('stayfit-index') }}">Home</a>
                        <ul class="submenu">
                            <li><a href="{{ route('stayfit-index') }}">Home Style One</a></li>
                    ...
                    <li class=" dropdown"><a href="{{ route('stayfit-about') }}">About us</a>
                        <ul class="submenu">
                    ...
                    <li class=" dropdown"><a href="{{ route('stayfit-blog') }}">Blog</a>
                        <ul class="submenu">
                            <li><a href="blog-without-sidebar.html">Blog Full Width</a></li>
                            <li><a href="{{ route('stayfit-blog') }}">Blog Left Sidebar</a></li>
                            <li><a href="blog-right-sidebar.html">Blog Right Sidebar</a></li>
                            <li><a href="{{ route('stayfit-blog-left-right') }}">Blog Left Right Sidebar</a></li>
                            <li><a href="{{ route('stayfit-blog-details') }}">Single Post</a></li>
                        </ul>
                    </li>

                    <li class="current"><a href="{{ route('stayfit-contact') }}">Contact</a></li>
                </ul>
