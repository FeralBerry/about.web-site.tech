            ...
            <div class="tp-banner" >
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/bg-one.jpg"  data-saveperformance="off"  data-title="We Serve Quality"> <!-- MAIN IMAGE -->
                        <img src="{{ asset('front/stayfit/images/main-slider/bg-one.jpg') }}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption lfb tp-resizeme"
                             ...
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer light-blue"><h3>GET FIT IN LESS THAN 6 WEEKS</h3></div></div>
                        ...
                        <div class="tp-caption lfb tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer dark-blue"><h2>ARE YOU READY TO CHANGE YOURSELVE?</h2></div></div>
                        ...
                        <div class="tp-caption lfb tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer light-blue"><a href="#"><span class="fa fa-play-circle"></span> &ensp; TRY OUT THIS PLAN FOR 30 DAYS AND TOTALLY FREE</a></div></div>
                    ...
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/bg-two.jpg"  data-saveperformance="off"  data-title="We Serve Quality"> <!-- MAIN IMAGE -->
                        <img src="{{ asset('front/stayfit/images/main-slider/bg-two.jpg') }}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption stb tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer dark-blue"><h2>CHANGE YOURSELVE AND TRY YOUR WORKPUT AT OUR GYM!</h2></div></div>
                    ...
                    <li data-transition="slidedown" data-slotamount="1" data-masterspeed="1000" data-thumb="images/main-slider/bg-three.jpg"  data-saveperformance="off"  data-title="We Serve Quality"> <!-- MAIN IMAGE -->
                        <img src="{{ asset('front/stayfit/images/main-slider/bg-three.jpg') }}"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption lfb stb tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer light-pink"><h2>WORKOUT FOR WOMEN</h2></div></div>
                        ...
                        <div class="tp-caption lfb stb tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer dark-blue"><h3>TAKE A LOOK AT THE  FITNESS COURSES</h3></div></div>
                        ...
                        <div class="tp-caption lfr tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer light-blue"><h2>WORKOUT FOR MEN</h2></div></div>
                        ...
                        <div class="tp-caption lfr tp-resizeme"
                             ...
                             data-endspeed="1200"
                             data-endeasing="Power4.easeIn"
                             style="z-index: 4; max-width: 100%; max-height: 100%; white-space: nowrap;"><div class="curved-layer dark-blue"><h3>HECK OUT THE 6 WEEKS FITNESS PLAN</h3></div></div>
            ...
            <div class="row clearfix">
                ...
                <article class="col-md-4 col-sm-6 col-xs-12">
                    <div class="post style-two wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1.5s" data-wow-offset="0">
                        <img src="{{ asset('front/stayfit/images/resource/image-1.png') }}" alt="">
                        <div class="title-box">
                            <h2 class="clearfix">
                ...
                <article class="col-md-4 col-sm-12 col-xs-12">
                    <div class="post style-three wow fadeInRight" data-wow-delay="0.5s" data-wow-duration="1.5s" data-wow-offset="0">
                        <img src="{{ asset('front/stayfit/images/resource/image-2.png') }}" alt="">
                        <div class="post-cont">
                            <div class="post-text">
                    ...
                    <div class="workout-sessions">
                        ...
                        <div class="post wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                            ...
                            <div class="images clearfix">
                                <div class="col-md-4 col-sm-4 col-xs-12"><img src="{{ asset('front/stayfit/images/resource/image-3.jpg') }}" alt="" title=""></div>
                                <div class="col-md-4 col-sm-4 col-xs-12"><img src="{{ asset('front/stayfit/images/resource/image-4.jpg') }}" alt="" title=""></div>
                                <div class="col-md-4 col-sm-4 col-xs-12"><img src="{{ asset('front/stayfit/images/resource/image-5.jpg') }}" alt="" title=""></div>
                            </div>
                        </div>
                        ...
                        <div class="post wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                            ...
                            <div class="images clearfix">
                                <div class="col-md-4 col-sm-4 col-xs-12"><img src="{{ asset('front/stayfit/images/resource/image-6.jpg') }}" alt="" title=""></div>
                                <div class="col-md-4 col-sm-4 col-xs-12"><img src="{{ asset('front/stayfit/images/resource/image-7.jpg') }}" alt="" title=""></div>
                                <div class="col-md-4 col-sm-4 col-xs-12"><img src="{{ asset('front/stayfit/images/resource/image-8.jpg') }}" alt="" title=""></div>
                            </div>
                        </div>
        ...
        <div class="slider">
            ...
            <article class="slide-item">
                <div class="auto-container">
                    ...
                    <figure class="image-box">
                        <div class="image-layer" style="background-image:url({{ asset('front/stayfit/images/resource/image-11.jpg') }});"></div>
            ...
            <article class="slide-item">
                <div class="auto-container">
                    ...
                    <figure class="image-box">
                        <div class="image-layer" style="background-image:url({{ asset('front/stayfit/images/resource/image-12.jpg') }});"></div>
                        <div class="text-layer">
                            <ul class="text">
                                <li>Liza Boye</li>
            ...
            <div class="row clearfix">
                ...
                <article class="col-md-6 col-sm-6 col-xs-12 product">
                    ...
                    <figure class="image">
                        ...
                        <img src="{{ asset('front/stayfit/images/resource/image-9.jpg') }}" alt="" title="">
                    </figure>
                </article>
                ...
                <article class="col-md-6 col-sm-6 col-xs-12 product">
                    ...
                    <figure class="image">
                        ...
                        <img src="{{ asset('front/stayfit/images/resource/image-10.jpg') }}" alt="" title="">
                    </figure>
                </article>
