@extends('front.clothing.layout')
@section('content')
    <!--slider area start-->
    <div class="slider-area pos-rltv carosule-pagi cp-line">
        <div class="active-slider">
            <div class="single-slider pos-rltv">
                <div class="slider-img"><img src="{{ asset('front/clothing') }}/images/slider/slider01.jpg" alt=""></div>
            ...
            <div class="single-slider pos-rltv">
                <div class="slider-img"><img src="{{ asset('front/clothing') }}/images/slider/slider02.jpg" alt=""></div>
                <div class="slider-content pos-abs">
                    <h4>Best Collection</h4>
                    <h1 class="uppercase pos-rltv underline">exclusive Fashion 2016</h1>
                    <a href="#" class="btn-def btn-white">Shop Now</a>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="single-service shadow-box text-center">
                        <img src="{{ asset('front/clothing') }}/images/icons/garantee.png" alt="">
                        <h5>Money Back Guarantee</h5>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="single-service shadow-box text-center">
                        <img src="{{ asset('front/clothing') }}/images/icons/coupon.png" alt="">
                        <h5>Gift Coupon</h5>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="single-service shadow-box text-center">
                        <img src="{{ asset('front/clothing') }}/images/icons/delivery.png" alt="">
                        <h5>Free Shipping</h5>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="single-service shadow-box text-center">
                        <img src="{{ asset('front/clothing') }}/images/icons/support.png" alt="">
                        <h5>24x7 Support</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single-slider">
                        <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12">
                            <div class="brand-img text-center">
                                <img src="{{ asset('front/clothing') }}/images/team/branding.png" alt="">
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                ...
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt="" src="{{ asset('front/clothing') }}/images/product/01.jpg" class="primary-image"> <img alt="" src="{{ asset('front/clothing') }}/images/product/02.jpg" class="secondary-image"> </a>
                                                </div>
                                                <div class="product-icon socile-icon-tooltip text-center">
                                                    <ul>
                                                        <li><a href="#" data-tooltip="Add To Cart" class="add-cart" data-placement="left"><i class="fa fa-cart-plus"></i></a></li>
                    ...
                    <div class="total-testimonial active-slider carosule-pagi pagi-03">
                        <div class="single-testimonial">
                            <div class="testimonial-img">
                                <img src="{{ asset('front/clothing') }}/images/team/testi-03.jpg" alt="">
                            </div>
                        ...
                        <div class="single-testimonial">
                            <div class="testimonial-img">
                                <img src="{{ asset('front/clothing') }}/images/team/testi-02.jpg" alt="">
                            </div>
                            <div class="testimonial-content color-lightgrey">
                                <div class="name-degi pos-rltv">
                        ...
                        <div class="single-testimonial">
                            <div class="testimonial-img">
                                <img src="{{ asset('front/clothing') }}/images/team/testi-01.jpg" alt="">
                            </div>
                            <div class="testimonial-content color-lightgrey">
                                <div class="name-degi pos-rltv">
                                    <h5>Momen Buhyan</h5>
        ...
        <div class="container">
            <div class="row">
                <div class="total-brand">
                    <div class="col-md-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="{{ asset('front/clothing') }}/images/brand/01.png" alt=""></a></div>
                    </div>
                    <div class="col-md-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="{{ asset('front/clothing') }}/images/brand/02.png" alt=""></a></div>
                    </div>
                    <div class="col-md-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="{{ asset('front/clothing') }}/images/brand/03.png" alt=""></a></div>
                    </div>
                    <div class="col-md-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="{{ asset('front/clothing') }}/images/brand/04.png" alt=""></a></div>
                    </div>
                    <div class="col-md-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="{{ asset('front/clothing') }}/images/brand/05.png" alt=""></a></div>
                    </div>
                    <div class="col-md-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="{{ asset('front/clothing') }}/images/brand/06.png" alt=""></a></div>
                    </div>
                    <div class="col-md-3">
                        <div class="single-brand shadow-box"><a href="#"><img src="{{ asset('front/clothing') }}/images/brand/01.png" alt=""></a></div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="total-blog">
                    <div class="col-md-4">
                        <div class="single-blog">
                            <div class="blog-img pos-rltv product-overlay">
                                <a href="#"><img src="{{ asset('front/clothing') }}/images/blog/01.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="single-blog">
                            <div class="blog-img pos-rltv product-overlay">
                                <a href="#"><img src="{{ asset('front/clothing') }}/images/blog/02.jpg" alt=""></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-title">
                                    <h5 class="uppercase font-bold"><a href="#">New fashion collection 2016</a></h5>
                    ...
                    <div class="col-md-4">
                        <div class="single-blog">
                            <div class="blog-img pos-rltv product-overlay">
                                <a href="#"><img src="{{ asset('front/clothing') }}/images/blog/03.jpg" alt=""></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-title">
                                    <h5 class="uppercase font-bold"><a href="#">New fashion collection 2016</a></h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 hidden-sm col-xs-12">
                    <div class="single-footer instagrm-area">
                        ...
                        <div class="instagrm">
                            <ul>
                                <li><a href="#"><img src="{{ asset('front/clothing') }}/images/gallery/01.jpg" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('front/clothing') }}/images/gallery/02.jpg" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('front/clothing') }}/images/gallery/03.jpg" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('front/clothing') }}/images/gallery/04.jpg" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('front/clothing') }}/images/gallery/05.jpg" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('front/clothing') }}/images/gallery/06.jpg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <ul class="payment-support text-right">
                                <li>
                                    <a href="#"><img src="{{ asset('front/clothing') }}/images/icons/pay1.png" alt="" /></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('front/clothing') }}/images/icons/pay2.png" alt="" /></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('front/clothing') }}/images/icons/pay3.png" alt="" /></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('front/clothing') }}/images/icons/pay4.png" alt="" /></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('front/clothing') }}/images/icons/pay5.png" alt="" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
