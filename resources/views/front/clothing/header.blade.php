                            ...
                            <ul class="main-menu">
                                ...
                                <li class="mega-parent pos-rltv"><a href="shop.html">Man</a>
                                    <div class="mega-menu-area mma-800">
                                        ...
                                        <div class="mega-banner-img">
                                            <a href="single-product.html"><img src="{{ asset('front/clothing') }}/images/banner/banner-fashion-02.jpg" alt=""></a>
                                        </div>
                                    </div>
                                </li>
                                <li class="mega-parent pos-rltv"><a href="shop.html">Women</a>
                                    <div class="mega-menu-area mma-700">
                                        ...
                                        <div class="mega-banner-img">
                                            <a href="single-product.html"><img src="{{ asset('front/clothing') }}/images/banner/banner-fashion.jpg" alt=""></a>
                                        </div>
                                    </div>
                                </li>
