...
<!-- CSS Files -->
<link href="{{ asset('front/brand/css/bootstrap.min.css') }}" rel="stylesheet" media="screen">
<link href="{{ asset('front/brand/css/font-awesome.min.css') }}" rel="stylesheet">
<link href="{{ asset('front/brand/fonts/icon-7-stroke/css/pe-icon-7-stroke.css') }}" rel="stylesheet">
<link href="{{ asset('front/brand/css/animate.css') }}" rel="stylesheet" media="screen">
<link href="{{ asset('front/brand/css/owl.theme.css') }}" rel="stylesheet">
<link href="{{ asset('front/brand/css/owl.carousel.css') }}" rel="stylesheet">

<link href="{{ asset('front/brand/css/styles.css') }}" rel="stylesheet" media="screen">
	...
	<nav class="navbar-wrapper navbar-default" role="navigation">
		<div class="container">
			  <div class="navbar-header">
				...
				<a class="navbar-brand site-name" href="#top"><img src="{{ asset('front/brand/images/logo.png') }}" alt="logo"></a>
			  </div>
...
<div class="fullscreen landing parallax banner" style="background-image:url({{ asset('front/brand/images/bg.jpg') }});" data-img-width="2000" data-img-height="1325" data-diff="100">
...
<div id="intro">
	...
	<!-- feature image -->
			<div class="col-md-6 feature-2-pic wow fadeInLeft">
				<img src="{{ asset('front/brand/images/feature2-image.jpg') }}" alt="image" class="img-responsive">
			</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 wow fadeInLeft animated" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; -webkit-animation-delay: 0.8s; animation-name: fadeInLeft; -webkit-animation-name: fadeInLeft;">
                    <div class="block">
                        <img class="img-responsive" src="{{ asset('front/brand/images/featured-app.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<!-- subscribe section -->
<div id="subscribe">
	<div class="subscribe fullscreen parallax" style="background-image:url({{ asset('front/brand/images/bg.jpg') }});" data-img-width="1920" data-img-height="1281" data-diff="100">
		<div class="overlay">
			<div class="container">
		...
		<div class="row screenshots">
			...
			<div id="screenshots" class="owl-carousel">
				...
				<div class="screen wow fadeInUp">
					<a href="{{ asset('front/brand/images/img1.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img1.jpg') }}" alt="Screenshot"></a>
				</div>

				<div class="screen wow fadeInUp" data-wow-delay="0.1s">
					<a href="{{ asset('front/brand/images/img2.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img2.jpg') }}" alt="Screenshot"></a>
				</div>

				<div class="screen wow fadeInUp" data-wow-delay="0.2s">
					<a href="{{ asset('front/brand/images/img3.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img3.jpg') }}" alt="Screenshot"></a>
				</div>

				<div class="screen wow fadeInUp" data-wow-delay="0.3s">
					<a href="{{ asset('front/brand/images/img4.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img4.jpg') }}" alt="Screenshot"></a>
				</div>

				<div class="screen wow fadeInUp" data-wow-delay="0.4s">
					<a href="{{ asset('front/brand/images/img5.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img5.jpg') }}" alt="Screenshot"></a>
				</div>

				<div class="screen wow fadeInUp" data-wow-delay="0.5s">
					<a href="{{ asset('front/brand/images/img6.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img6.jpg') }}" alt="Screenshot"></a>
				</div>

				<div class="screen wow fadeInUp" data-wow-delay="0.6s">
					<a href="{{ asset('front/brand/images/img7.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img7.jpg') }}" alt="Screenshot"></a>
				</div>

				<div class="screen wow fadeInUp" data-wow-delay="0.7s">
					<a href="{{ asset('front/brand/images/img8.jpg') }}" data-toggle="lightbox"><img src="{{ asset('front/brand/images/img8.jpg') }}" alt="Screenshot"></a>
				</div>
			</div>
		</div>
	</div>
			   ...
			   <div id="owl-clients" class="owl-carousel owl-theme wow fadeInUp">
					...
					<div class="clients-item">
						<div class="client-pic text-center">
							...
							<!-- client photo -->
							<img src="{{ asset('front/brand/images/client.jpg') }}" alt="client">
						</div>
						<div class="box">
					...
					<div class="clients-item">
						<div class="client-pic text-center">
							...
							<!-- client photo -->
							<img src="{{ asset('front/brand/images/client2.jpg') }}" alt="client">
						</div>
						<div class="box">
					...
					<div class="clients-item">
						<div class="client-pic text-center">
							...
							<!-- client photo -->
							<img src="{{ asset('front/brand/images/client3.jpg') }}" alt="client">
						</div>
						<div class="box">
...
<!-- download section -->
<div id="download">
	<div class="action fullscreen parallax" style="background-image:url({{ asset('front/brand/images/bg.jpg') }});" data-img-width="2000" data-img-height="1334" data-diff="100">
...
<footer id="footer">
	...
	<!-- javascript files -->
    <script src="{{ asset('front/brand/js/jquery.js') }}"></script>
    <script src="{{ asset('front/brand/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('front/brand/js/custom.js') }}"></script>
    <script src="{{ asset('front/brand/js/jquery.sticky.js') }}"></script>
	<script src="{{ asset('front/brand/js/wow.min.js') }}"></script>
	<script src="{{ asset('front/brand/js/owl.carousel.min.js') }}"></script>
	<script src="{{ asset('front/brand/js/ekko-lightbox-min.js') }}"></script>
