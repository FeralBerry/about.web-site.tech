            ...
            <div class="container nz-clearfix">
                <div class="logo logo-desk">
                    <a href="{{ route('monsterat-index') }}" title="Montserrat">
                        <img class="normal-logo" id="img_4eba_1" src="{{ asset('front/monsterat/upload/logo_white%402.png') }}" alt="Montserrat">
                        <img class="fixed-logo" id="img_4eba_2" src="{{ asset('front/monsterat/upload/logo_black%402.png') }}" alt="Montserrat">
                    </a>
                </div>
