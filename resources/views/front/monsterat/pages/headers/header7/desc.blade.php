            ...
            <div class="container nz-clearfix">
                ...
                <nav class="header-top-menu nz-clearfix">
                    <ul id="header-top-menu" class="menu">
                        <li id="menu-item-4553" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-4553"><a href="javascript:void(0)"><span class="mi"></span><span class="txt">Solutions</span></a>
                            <ul class="sub-menu">
                        ...
                        <li id="menu-item-4554" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-4554"><a href="javascript:void(0)"><span class="mi"></span><span class="txt">Products</span></a>
                            <ul class="sub-menu">
                        ...
                        <li id="menu-item-4555" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4555"><a href="javascript:void(0)"><span class="mi"></span><span class="txt">News &#038; Events</span></a></li>
            ...
            <div class="container nz-clearfix">
                <div class="logo logo-desk">
                    <a href="{{ route('monsterat-index') }}" title="Montserrat">
                        <img class="normal-logo" id="img_dca7_1" src="{{ asset('front/monsterat/upload/logo_black%402.png') }}" alt="Montserrat">
