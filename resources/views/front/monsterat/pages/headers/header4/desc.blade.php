<header class="header desk version2 page-title-section-version1 one-page-side stuck-true top-false full-width-false sl-true search-true cart-true sidebar-toggle-true iversion-light effect-underline hover-effect-fill megamenu-hover-effect-underline subeffect-move fixed-true fiversion-dark wiversion-light">
                ...
                <div class="logo-part">
                    <div class="logo logo-desk">
                        <a href="{{ route('monsterat-index') }}" title="Montserrat">
                            <img class="normal-logo" id="img_0395_1" src="{{ asset('front/monsterat/upload/logo%402.png') }}" alt="Montserrat">
                            <img class="fixed-logo" id="img_0395_2" src="{{ asset('front/monsterat/upload/logo_black%402.png') }}" alt="Montserrat">
                        </a>
                    </div>
                </div>
