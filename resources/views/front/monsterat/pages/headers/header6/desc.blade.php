            ...
            <div class="container nz-clearfix">
                ...
                <nav class="header-top-menu nz-clearfix">
                    <ul id="header-top-menu" class="menu">
                        ...
                        <li id="menu-item-4579" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-4579"><a href="javascript:void(0)"><span class="mi"></span><span class="txt">Company</span></a>
                            <ul class="sub-menu">
