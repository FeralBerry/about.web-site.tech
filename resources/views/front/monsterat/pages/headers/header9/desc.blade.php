<header class="header desk version1 page-title-section-version1 one-page-side stuck-true stuck-boxed-true top-false full-width-false sl-true search-true cart-true sidebar-toggle-true iversion-dark effect-overline hover-effect-fill megamenu-hover-effect-underline subeffect-ghost fixed-true fiversion-dark wiversion-light">
            ...
            <div class="container nz-clearfix">
                <div class="logo logo-desk">
                    <a href="{{ route('monsterat-index') }}" title="Montserrat">
                        <img class="normal-logo" id="img_a83d_1" src="{{ asset('front/monsterat/upload/logo_black%402.png') }}" alt="Montserrat">
                        <img class="fixed-logo" id="img_a83d_2" src="{{ asset('front/monsterat/upload/logo_black%402.png') }}" alt="Montserrat">
                    </a>
                </div>
