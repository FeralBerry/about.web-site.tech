<header class="header desk version1 page-title-section-version1 one-page-side stuck-false stuck-boxed-false top-true full-width-true sl-false search-true cart-true sidebar-toggle-true iversion-dark effect-outline hover-effect-fill megamenu-hover-effect-underline subeffect-fade fixed-true fiversion-dark wiversion-light">
            ...
            <div class="container nz-clearfix">
                ...
                <div class="logo logo-desk">
                    <a href="{{ route('monsterat-index') }}" title="Montserrat">
                        <img class="normal-logo" id="img_9bcf_1" src="{{ asset('front/monsterat/upload/logo_black%402.png') }}" alt="Montserrat">
                        <img class="fixed-logo" id="img_9bcf_2" src="{{ asset('front/monsterat/upload/logo_black%402.png') }}" alt="Montserrat">
                    </a>
                </div>
