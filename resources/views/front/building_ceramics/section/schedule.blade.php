<div class="container-fluid no-padding schedule-section">
    ...
    <div class="container">
        ...
        <div class="schedule-block">
            <img src="{{ asset('front/building_ceramics/images/schedule.jpg') }}" alt="schedule"/>
            <div class="col-md-11">
                                ...
                                <div id="schedule_accrodion_content_1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="schedule_accrodion_heading_1">
                                    <div class="panel-body">
                                        ...
                                        <div class="author-box">
                                            <img src="{{ asset('front/building_ceramics/images/slider-thumb1.jpg') }}" alt="slider-thumb" width="74" height="74"/>
