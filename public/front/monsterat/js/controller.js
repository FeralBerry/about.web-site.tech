...
/*======================*/
	...
	(function($){
		...
		$('.rich-headers').each(function(){
			var win   = $(window);
			var $this = $(this);
			win.scroll(function(){
				var percent = ($(document).scrollTop()/win.height());
				$this.find('.rich-headers-content').css('opacity', 1 - percent);
			});
		});
		...
		$('.i-separator').each(function(){
			...
			if ($this.data('target') !== undefined) {
				...
				$this.bind('click.smoothscroll', function (event) {
				    ...
				    var targetOffset = ($('.headers.fixed-true').hasClass('active')) ?
				    $this.attr('data-offset') :
				    $this.attr('data-from');

				    if ($('.headers.fixed-true').hasClass('stuck-true')) {
...
/*======================*/
	...
	(function($){
		"use strict";
        let el1 = document.querySelectorAll('.menu-item-has-children')

        for (let i = 0; i < el1.length; i++) {
            let open_sub_menu = false;
            el1[i].addEventListener('click',function (event){
                let elem = el1[i].querySelectorAll('.sub-menu')
        ...
        let el2 = document.querySelectorAll('.widget-area .widget_icl_lang_sel_widget > div > ul > li > a')
        for (let i = 0; i < el2.length; i++) {
            el2[i].addEventListener('click',function (event){
                event.preventDefault();
                document.querySelector('.widget-area .widget_icl_lang_sel_widget').toggleClass('animated')
                el2[i].next('ul').slideToggle(300, "easeOutQuart");
            })
        }

        let open_mob_menu = false;
        let el4 = document.getElementsByClassName('mob-menu-toggle')
        for (let i = 0; i < el4.length; i++) {
            el4[i].addEventListener('click', function(event){
                $(this).toggleClass('animated')
                let content = document.querySelectorAll('.mob-header-content')
		...
		// Header submenu
			...
			$('.subeffect-ghost .desk-menu ul li, .subeffect-ghost .headers-top-menu ul li').hoverIntent(
				function(){
					var $this = $(this);
					$this.children('ul')
					.stop(true, true)
			...
			$('.subeffect-move .desk-menu ul li, .subeffect-move .headers-top-menu ul li').hoverIntent(
				function(){
					var $this = $(this);
					$this.children('ul')
					.stop(true, true)
			...
			$('.subeffect-fade .desk-menu ul li, .subeffect-fade .headers-top-menu ul li').hoverIntent(
				function(){
					var $this = $(this);
					$this.children('ul')
					.stop(true, true)
			...
			$('.subeffect-slide .desk-menu ul li, .subeffect-slide .headers-top-menu ul li').hoverIntent(
				function(){
					var $this = $(this);
					$this.children('ul')
					.stop(true, true)
...
/*======================*/
	...
	(function($){
		...
		parallax($('.rich-headers[data-parallax="true"]'),false);
